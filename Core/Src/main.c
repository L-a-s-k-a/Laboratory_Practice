...
int main(void)
{
    ...
    *(uint32_t*)(0x40020400UL + 0x18UL) |= 0x800000;
    //PB14
    *(uint32_t*)(0x400207FF + 0x00) |= 0x20000000;
    //*(uint32_t*)(0x400207FF + 0x04) |=
    //SpeedmodeReg
    *(uint32_t*)(0x400207FF + 0x08) |= 0x20000000;
    //PullUpPulldownReg
    //*(uint32_t*)(0x400207FF + 0x0C) |= ;
    //Outputdatareg ODR
    *(uint32_t*)(0x400207FF + 0x14) |= 0x2000;
    //Outputdatasetresetreg BSRR
    *(uint32_t*)(0x400207FF + 0x18) |= 0x20000000;
    while(1)
    {
        *(uint32_t*)(0x40020400UL + 0x18UL) |= 0x2000;
        *(uint32_t*)(0x400207FF + 0x00) |= 0x2000;
