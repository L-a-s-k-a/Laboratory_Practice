...
void GPIO_Ini(void)
{
    ...
    SET_BIT(GPIOB->MODER, GPIO_MODER_MODER12_0);        // Настройка работы 14-го пина GPIOB в режиме вывода сигнала (Output mode)
    ...
    SET_BIT(GPIOB->MODER, GPIO_MODER_MODER13_0);        // Настройка работы 14-го пина GPIOB в режиме вывода сигнала (Output mode)
    ...
    SET_BIT(GPIOB->MODER, GPIO_MODER_MODER15_0);        // Настройка работы 14-го пина GPIOB в режиме вывода сигнала (Output mode)
    ...
    SET_BIT(GPIOB->MODER, GPIO_MODER_MODER8_0);        // Настройка работы 14-го пина GPIOB в режиме вывода сигнала (Output mode)
